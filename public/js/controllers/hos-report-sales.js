...
app.controller('HospitalSalesCtrl', ['$scope', function($scope) {
    ...
    $scope.chart5 = [ 
      { label: "Laboratory", data: 40 }, 
      { label: "Pharmacy", data: 10 },
      { label: "Fitness Training", data: 20 },
      { label: "Equipments", data: 12 },
      { label: "Health Magazine", data: 18 }
    ];
