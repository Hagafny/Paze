...
app.controller('ProductStatsCtrl', ['$scope', function($scope) {
    ...
    $scope.chart5 = [ 
      { label: "Students", data: 40 }, 
      { label: "Bloggers", data: 10 },
      { label: "Celebrities", data: 20 },
      { label: "Industrialists", data: 12 },
      { label: "Marketers", data: 18 }
    ];
