...
app.controller('CustomerCountCtrl', ['$scope', function($scope) {
    ...
    $scope.chart5 = [ 
      { label: "Online Ads", data: 40 }, 
      { label: "Direct Contacts", data: 10 },
      { label: "Sales Communication Team", data: 20 },
      { label: "Newspaper", data: 12 },
      { label: "Other", data: 18 }
    ];
