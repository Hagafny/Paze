...
app.controller('UniversityProfessorCtrl', ['$scope', function($scope) {
    ...
    $scope.chart5 = [ 
      { label: "Mechanical Engg.", data: 40 }, 
      { label: "Computer Engg.", data: 10 },
      { label: "Electronics & Communication Engg.", data: 20 },
      { label: "Civil Engg.", data: 12 },
      { label: "Electrical Engg.", data: 18 }
    ];
